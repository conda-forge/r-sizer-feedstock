...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-sizer-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-sizer-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-sizer-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-sizer-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-sizer-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-sizer-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-sizer` can be installed with:

```
conda install r-sizer
```

It is possible to list all of the versions of `r-sizer` available on your platform with:
